...
/** Names a shard by (indexUuid, shardId) for {@link ShardPartitionRewriteAction}. */
public class ShardPartitionRewriteRequest extends ActionRequest {
     ...
     */
    public ShardPartitionRewriteRequest(String indexUuid, int shardId) {
     ...
     *
     * @param in stream positioned at a previously-{@link #writeTo}-written {@link ShardPartitionRewriteRequest}.
     */
    public ShardPartitionRewriteRequest(StreamInput in) throws IOException {
        super(in);
