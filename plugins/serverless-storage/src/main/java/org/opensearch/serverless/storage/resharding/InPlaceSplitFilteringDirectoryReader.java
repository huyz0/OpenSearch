 ...
 *
 * <p>Shares its wrapping/live-doc-rebuilding machinery with {@link PartitionFilteringDirectoryReader}
 * via {@link AbstractIdFilteringDirectoryReader} (see that class's javadoc for the design rationale,
 * which applies unchanged here); this subclass supplies only the {@link InPlaceSplitPartitionFilter}
 * predicate and this mechanism's own {@link #getReaderCacheHelper()} behavior.
 */
public final class InPlaceSplitFilteringDirectoryReader extends AbstractIdFilteringDirectoryReader {
