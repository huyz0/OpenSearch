...
/** Names a shard by (indexUuid, shardId) for {@link ShardIdleTimeAction}. */
public class ShardIdleTimeRequest extends ActionRequest {
     ...
     */
    public ShardIdleTimeRequest(String indexUuid, int shardId) {
     ...
     *
     * @param in stream positioned at a previously-{@link #writeTo}-written {@link ShardIdleTimeRequest}.
     */
    public ShardIdleTimeRequest(StreamInput in) throws IOException {
        super(in);
