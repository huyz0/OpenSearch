...
/** Names a shard by (indexUuid, shardId) and a {@code snapshotId} for {@link SnapshotRestoreAction}. */
public class SnapshotRestoreRequest extends ActionRequest {
    ...
    /** The snapshot name whose pinned generation the shard's head should be restored to. */
