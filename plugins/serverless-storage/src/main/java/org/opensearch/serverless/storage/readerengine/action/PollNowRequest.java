...
/** Names a shard by (indexUuid, shardId) for {@link PollNowAction}. */
public class PollNowRequest extends ActionRequest {
     ...
     */
    public PollNowRequest(String indexUuid, int shardId) {
     ...
     *
     * @param in stream positioned at a previously-{@link #writeTo}-written {@link PollNowRequest}.
     */
    public PollNowRequest(StreamInput in) throws IOException {
        super(in);
