...
/** Names a shard by (indexUuid, shardId) and a {@code snapshotId} for {@link SnapshotReleaseAction}. */
public class SnapshotReleaseRequest extends ActionRequest {
     ...
     * @param snapshotId the snapshot name whose pin should be released.
     */
    public SnapshotReleaseRequest(String indexUuid, int shardId, String snapshotId) {
     ...
     *
     * @param in stream positioned at a previously-{@link #writeTo}-written {@link SnapshotReleaseRequest}.
     */
    public SnapshotReleaseRequest(StreamInput in) throws IOException {
        super(in);
    ...
    /** The snapshot name whose pin should be released. */
