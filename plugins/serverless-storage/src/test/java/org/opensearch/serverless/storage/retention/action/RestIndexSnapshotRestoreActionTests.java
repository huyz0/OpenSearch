...
/**
 * Proves {@link RestIndexSnapshotRestoreAction#prepareRequest} correctly parses a well-formed
 ...
 * isolation.
 */
public class RestIndexSnapshotRestoreActionTests extends OpenSearchTestCase {

    private final RestIndexSnapshotRestoreAction action = new RestIndexSnapshotRestoreAction();
    ...
    private static RestRequest requestWithBody(String json) {
        return new FakeRestRequest.Builder(NamedXContentRegistry.EMPTY).withContent(new BytesArray(json), XContentType.JSON)
            ...
            .withPath("/_plugins/_serverless/storage/index/my-index/_snapshot_restore")
