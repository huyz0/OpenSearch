...
public class ShardSplittingQueryTests extends OpenSearchTestCase {
    ...
    public void testSplitOnNoopOnlySegment() throws IOException {
        // Bug fix regression test: a segment containing only a no-op/tombstone doc has no _id term at
        // all, so leafReader.terms(IdFieldMapper.NAME) legitimately returns null -- findSplitDocs used to
        // NPE on that instead of treating "no terms" as "no docs to find."
