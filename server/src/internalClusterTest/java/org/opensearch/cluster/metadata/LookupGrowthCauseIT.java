 ...
 * was the dictionary.
 *
 * <p>Run at one million rather than ten. The distinction does not need the larger population, since the
 * question is about the shape of the cost and not its size, and a force merge of ten million documents on
 * a single-JVM cluster is minutes of merging for no extra information.
 *
 * <p>Requires a raised heap, as S28 records: both {@code -Dtests.heap.size} and
 * {@code -Poptions.forkOptions.memoryMaximumSize}.
 */
public class LookupGrowthCauseIT extends OpenSearchIntegTestCase {
