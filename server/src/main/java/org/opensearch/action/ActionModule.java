...
import org.opensearch.action.admin.indices.split.TransportInPlaceMergeShardAction;
import org.opensearch.action.admin.indices.split.TransportInPlaceSplitShardAction;
...
import org.opensearch.rest.action.admin.indices.RestInPlaceMergeShardAction;
import org.opensearch.rest.action.admin.indices.RestInPlaceSplitShardAction;
...
public class ActionModule extends AbstractModule {
    ...
    static Map<String, ActionHandler<?, ?>> setupActions(List<ActionPlugin> actionPlugins) {
        ...
        actions.register(InPlaceSplitShardAction.INSTANCE, TransportInPlaceSplitShardAction.class);
        actions.register(InPlaceMergeShardAction.INSTANCE, TransportInPlaceMergeShardAction.class);
    ...
    public void initRestHandlers(Supplier<DiscoveryNodes> nodesInCluster) {
        ...
        registerHandler.accept(new RestInPlaceSplitShardAction());
        registerHandler.accept(new RestInPlaceMergeShardAction());
