...
public class FsRepository extends BlobStoreRepository {
    ...
    public static final Setting<String> BASE_PATH_SETTING = Setting.simpleString("base_path", value -> {
        ...
        // containment check is performed in isUnderRepo().
     ...
     * backstop. Without containment, an absolute {@code base_path} would cause {@link Path#resolve} to discard the
     * validated location entirely and redirect all blob-store operations to an arbitrary filesystem path.
     */
