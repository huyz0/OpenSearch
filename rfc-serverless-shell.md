...
> the largest gap is that **M12/R11 has never been run**, so none of this has been shown on real object
> storage, and every process test runs one node against a local filesystem. The green table below is not
> the whole picture.
>
