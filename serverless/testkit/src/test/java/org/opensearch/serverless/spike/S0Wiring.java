...
final class S0Wiring {
    ...
    static IndicesService indicesService(
        ...
        return new IndicesService(
            ...
            Collections.emptyList(),
            emptyMap(),                             // directory factories
            emptyMap(),                             // composite directory factories
            emptyMap(),                             // data-format-aware store directory factories
            null,                                   // values source registry
            emptyMap(),                             // recovery state factories
            emptyMap(),                             // store factories
            null,                                   // remote directory factory
            () -> null,
            null,
            null,
